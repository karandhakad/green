              ...
              <div className="showCard-details" key={ind}>
                ...
                <div className="card-detail">
                  ...
                  <p className="description">
                    ...
                    vulputate. Fringilla venenatis elementum elementum neque
                    morbi non in. Nunc sagittis gravida scelerisque neque
                    integer amet. Gravida et risus dignissim elit sed eu rutrum
                  ...
                  <div className="cardBtns">
                    <div className="cardBtn1">
                      <p
                        className="buyCountBtn"
                        onClick={handleBuyCountDecrease}
                      >
                        -
                      </p>
                      ...
                      <p
                        className="buyCountBtn"
                        onClick={handleBuyCountIncrease}
                      >
                        +
                      </p>
                    </div>

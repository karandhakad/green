...
import cartLogo from '../assets/images/cart-round-logo.png'
...
function CardList() {
  ...
  ? cardsList.filter(card => card.category === selectedCategory) : cardsList
                    ...
                    <div className="card-details">
                      ...
                      <p className='card-rating'>
                         <Rating
                          ...
                          onChange={(e, newValue) => handleRatingChange(value.id, newValue)}
                        />
                      </p>
                      </div>
